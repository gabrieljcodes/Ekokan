...
export default function TagFilterPanel({
  ...
  return (
    <div className="tag-panel" role="group" aria-label="Tag filter panel">
      ...
      <div className="tag-panel__grid" role="listbox" aria-label="Available tags">
        {filteredTags.map((tag) => {
          ...
          return (
            <button
              ...
              type="button"
              role="option"
              aria-selected={isInc || isExc}
              aria-disabled={isPersistExc || undefined}
