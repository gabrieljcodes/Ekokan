...
export function IconDownload(props: IconProps = {}) {
  return svg(props, 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4', 'M7 10l5 5 5-5', 'M12 15V3');
}
...
export function IconEye({ size = 18, className, 'aria-hidden': ariaHidden = true }: IconProps = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconEyeOff({ size = 18, className, 'aria-hidden': ariaHidden = true }: IconProps = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
